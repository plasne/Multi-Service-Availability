            ...
            if (!base.eq.service) {
                ...
                base.evaluate = function(context) {
                    ...
                    if (service) {
                        ...
                        console.error("10433: condition (%s) could not be evaluated because service (%s) could not be found; it will be marked false.", base.name, base.eq.service);
                    }
                    return false;
                }
                ...
                base.validate = function(context) {
                    ...
                    if (global.msa_settings.loglevel >= 4) console.log("condition (%s) precheck for 10434 will look for service name (%s).", base.name, name);
