            ...
            if (!base.eq.service) {
                ...
                base.evaluate = function(context) {
                    ...
                    if (service) {
                        ...
                        throw new verror("10433: condition (%s) could not be evaluated because service (%s) could not be found.", base.name, base.eq.service);
                    }
                    return false;
                }
                ...
                base.validate = function(context) {
                    const service = context.services.find(function(s) { return (s.isLocal && s.name == base.eq.service) });
                    if (!service) {
