...
module.exports = {
    ...
    new: function(base) {
        ...
        var condition_with_same_name = me.conditions.find(function(c) { return (c.name == base.name) });
        ...
        if (base.eq) {
            ...
            if (!base.eq.service) {
                ...
                base.evaluate = function(context) {
                    const service = context.services.find(function(s) { return (s.name == base.eq.service) });
                    if (service) {
