...
module.exports = {
    ...
    new: function(base) {
        ...
        if (base.eq) {
            ...
            } else if (base.eq.state || base.eq.property || base.eq.report) {

// make it only one of the above.
                ...
                throw new Error("10433: conditions with eq comparison must have at least one of state, property, or report (" + base.name + ").");
            }
        }
