...
var result_manager = require("./result.js");

module.exports = {
    services: [],

    load: function(files, rule_manager) {
        var me = this;
        var wrapper = q.defer();
        var promises = [];
    ...
    new: function(base, rule_manager) {
        var me = this;
        base.manager = me;
        ...
        var service_with_same_name = me.services.find(function(s) { return (s.name == base.name) });
